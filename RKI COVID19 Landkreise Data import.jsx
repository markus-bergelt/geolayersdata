...
geolayers3.addToBrowser("https://opendata.arcgis.com/datasets/917fc37a709542548cc3be077a786c17_0.geojson", function(err, data){
    if(err){
        alert(err.message)
    }else{
        var style = {
    ...
    namingProp:"GEN",
    name:"RKI Landkreise " + (new Date).toDateString()
})